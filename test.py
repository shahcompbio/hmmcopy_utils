...
class TestReadCounter(unittest.TestCase):
    ...
    def run_readcounter(self):
        ReadCounter(self.bam, self.output, self.window_size, self.chromosomes, 20, True).main()
    ...
    def compare_wigs(self):
        ...
        #some reads are inexplicable missed by hmmcopy, in this case one read is missed.
...
class TestGCCounter(unittest.TestCase):
    ...
    def run_gccounter(self):
        GCCounter(self.reference, self.output, self.chromosomes, self.window_size).main()
